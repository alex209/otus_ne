...
## Приоритет исходящего трафика через провайдера "Ламас" (AS301)
...
## Балансировка на маршрутизаторе R18
...
Пинги и трасировка IPv4 c маршрутизатора R14 на R18

!["Пинги и трасировка IPv4 c маршрутизатора R14 на R18"](./img/ping_R14.png)

Пинги IPv4 c маршрутизатора R14 на все офисы

!["Пинги IPv4 c маршрутизатора R14 на офисы"](./img/ping_R14_all_office.png)

Пинги IPv4 c маршрутизатора R18 на все офисы

!["Пинги IPv4 c маршрутизатора R18 на офисы"](./img/ping_R18.png)

Пинги IPv6 c маршрутизатора R18 на все офисы

!["Пинги IPv6 c маршрутизатора R18 на офисы"](./img/ping_R18_ipv6.png)
